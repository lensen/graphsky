...
var gcCalFrame="#EEE";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=0 cellpadding=5 cellspacing=0":"border=0 cellpadding=0 cellspacing=1";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gsNavPrev="<div id='arrow-left' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<div id='arrow-right' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator
...
var gcCellBG="#EEE";	// default background color of the cells. Use "" for transparent!!!
...
var gcToggle="#33B5E5";	// the highlight color for the focused cell
