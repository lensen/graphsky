...
foreach ($graph_reports as $graph_report) {
    ...
    print "<a href=\"/graph_all_periods.php?$host_graph_args\"><img width=\"$width\" height=\"$height\" src=\"". get_graph_domainname() . "/graph.php?$host_graph_args&from=$from&until=$until\" /></a>";
}
